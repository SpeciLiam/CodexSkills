...
11. After each submission, confirm using visible confirmation page, confirmation email, or portal status evidence; close the confirmed application tab immediately after confirmation; update `applications.md`; and use Gmail both for evidence and for routine emailed verification codes when needed.
