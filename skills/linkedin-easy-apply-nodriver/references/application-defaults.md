...
- Visa sponsorship needed now or in the future: No
...
- Strongest location preference: New York City
- Next preference: San Francisco / Bay Area
- Other U.S. locations: acceptable
- Remote: acceptable
- In office: acceptable every day
- Hybrid: acceptable
- Relocation: acceptable for good-fit roles, especially NYC and SF/Bay Area

## Availability And Compensation

- Start date: two weeks from the current date, rounded forward to the next Monday.
- Salary expectation: use the midpoint of the salary range listed in the job
  description. If no range is listed and the field is required, leave manual
  unless a safe prior convention exists in the tracker.
...
- GPA: 3.9
- Start: August 2021
- End / graduation: December 2024

## Experience And Skills

- Professional software engineering experience: 1-2 years when the form allows a
  range or narrative answer. Use the resume's exact experience when the field is
  strict or asks for employer-specific dates.
- Skills: use the skills listed on Liam's tailored/current resume. Do not claim a
  technology that is not supported by the resume or application tracker.

## Demographics

- Race/ethnicity: Latino / White
- For gender, disability, veteran status, or any demographic field not listed
  here: prefer `Decline to self-identify` when available, unless a prior tracker
  convention says otherwise.

## Cover Letters And Written Responses

- Do not write or upload a cover letter unless the application requires one to
  continue.
