...
def main() -> int:
    ...
    state: dict[str, Any] = {
        ...
        "runPolicy": {
            ...
            "coverLetterPolicy": "If an application offers an optional cover letter upload or text field, tailor a concise role-specific cover letter from the job description and Liam's resume, include it, and record whether it was uploaded or pasted. The cover letter content must use Liam Van's real name, and uploaded PDFs must be named Liam_Van_<Company>_Cover_Letter.pdf, never Candidate_Name_... . Missing cover letter fields are not blockers.",
            "standingApproval": "Tailor, track, outreach when possible, include a tailored cover letter when an application offers an optional cover letter field/upload, and submit high-confidence routine applications.",
